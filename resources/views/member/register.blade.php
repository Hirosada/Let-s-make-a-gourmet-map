...
@extends('layouts')
@section('contents')
	{{ Form::open(['route' => 'post_regiser', 'method' => 'post']) }}
		<div class="inputs">
		...
		<div class="inputs">
			{{ Form::password('password', null, ['placeholder' => 'パスワード', 'name' => 'member_password', 'class' => 'input_form']) }}
			<i class="fa fa-unlock-alt f13e" aria-hidden="true"></i>
		</div>
		<div class="inputs">
			{{ Form::password('password', null, ['placeholder' => 'パスワード確認用', 'name' => 'member_password', 'class' => 'input_form']) }}
			<i class="fa fa-unlock-alt f13e" aria-hidden="true"></i>
		</div>
		<div class="inputs">
		...
		<div class="inputs">
			...
			<a id="zipcode_btn" style="cursor:pointer;">住所検索</a>
		</div>
		<div class="inputs">
